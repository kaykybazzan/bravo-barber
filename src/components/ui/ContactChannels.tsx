...
import { whatsappDisplay, whatsappHref } from "@/integrations/whatsapp";
import { mapsDirectionsHref } from "@/integrations/maps";
import { formatFullAddress, summarizeBusinessHours, telHref } from "@/utils/format";
...
export function ContactChannels({ onDark = false, className }: { onDark?: boolean; className?: string }) {
  ...
  const rows = [
    ...
    { icon: "whatsapp" as const, label: "WhatsApp", value: whatsappDisplay(), href: whatsappHref() },
