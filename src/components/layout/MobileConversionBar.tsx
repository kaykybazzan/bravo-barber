...
export function MobileConversionBar() {
  ...
  return (
    <nav aria-label="Ações rápidas" className="fixed inset-x-3 bottom-3 z-[var(--nx-z-floating)] md:hidden">
      <div className="grid overflow-hidden rounded-[var(--nx-button-radius)] border border-line bg-bg/95 shadow-lift backdrop-blur" style={{ gridTemplateColumns: `repeat(${config.actions.length}, minmax(0, 1fr))` }}>
